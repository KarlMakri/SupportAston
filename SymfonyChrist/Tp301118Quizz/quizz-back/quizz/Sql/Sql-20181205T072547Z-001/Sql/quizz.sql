...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 04 déc. 2018 à 23:05
...
(12, 'BioMan', 1, 12),
(13, 'Améliore, et augmente les compétences, la maîtrise des langues', 1, 9),
(14, 'Non', 0, 2),
(15, 'Informer, préserver le peuple', 0, 10),
(16, 'C\'est celui qui apporte, contribue et développe l\'environnement.', 1, 12);
...
(13, 11, 'Quel Président Français a contribué, a mis en place le projet Musée du Louvres', 1),
(14, 4, 'Git que signifie, quel est sa fonctionnalité ?', 2),
(15, 4, 'Git que signifie, quel est sa fonctionnalité ?', 2),
(16, 13, 'En quel année le Stade de France a ouvert ses portes ?', 1),
(17, 5, 'Melbourne est la Capitale d\'Australie', 1);
